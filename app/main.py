...
class RouterFlow(Flow[InitialState]):    
    ...
    def start_method(self):
        ...
        # Retornamos el estado actualizado para propagarlo al siguiente paso
        return self.state
    ...
    def finish_flow(self):
        ...
        return("end")
        # Evitamos sys.exit() para que el estado se conserve y se complete correctamente el flujo

if __name__ == "__main__":
    mensaje = ("Cobro 5000 euros al mes, puedo invertir 1000 euros al mes, "
               "estoy harto de que mi dinero solo pierda valor, ¡quiero ganar dinero como sea, quiero riesgo!")
    estado_inicial = InitialState(user_input=mensaje)
    flow = RouterFlow(initial_state=estado_inicial)
    flow.kickoff()
